...
public class Main {
    public static void main(String[] args) {
        ...
        Menu menu1 = new Menu();
        menu1.addFood(new Food("Food 1", 10, 100, 100));
        menu1.addFood(new Food("Food 2", 20, 200, 200));
        menu1.addDrink(new Drink("Drink 1", 5, 50, 50));
        menu1.addDrink(new Drink("Drink 2", 10, 100, 100));

        Menu menu2 = new Menu();
        menu2.addFood(new Food("Food 3", 10, 100, 100));
        menu2.addFood(new Food("Food 4", 20, 200, 200));
        menu2.addDrink(new Drink("Drink 3", 5, 50, 50));
        menu2.addDrink(new Drink("Drink 4", 10, 100, 100));
        ...
        SortedSet<Review>reviews1 = new TreeSet<Review>();
        SortedSet<Review>reviews2 = new TreeSet<Review>();
        ...
        foodDeliveryService.addRestaurant("Restaurant 1", new Location(1, 1), menu1, reviews1);
        foodDeliveryService.addRestaurant("Restaurant 2", new Location(2, 2), menu2, reviews2);

        foodDeliveryService.addOrder(foodDeliveryService.getUsers().get(0), new Location(1, 1), items1);
        foodDeliveryService.addOrder(foodDeliveryService.getUsers().get(1), new Location(2, 2), items2);
